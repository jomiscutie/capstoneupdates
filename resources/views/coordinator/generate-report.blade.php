...
<style>
    ...
    .dtr-report .card { border-radius: 1.5rem; box-shadow: var(--dtr-shadow-soft); border: 1px solid var(--dtr-border-soft); background: var(--dtr-card-bg); overflow: hidden; }
    ...
    .dtr-report .form-label { font-weight: 600; color: var(--dtr-text); margin-bottom: 0.5rem; }
    ...
    .dtr-report .btn-secondary { border-radius: var(--dtr-radius); padding: 0.75rem 1.75rem; font-weight: 500; border: 1px solid var(--dtr-input-border); background: var(--dtr-card-bg); color: var(--dtr-text); transition: transform var(--dtr-transition), background var(--dtr-transition); }
    .dtr-report .btn-secondary:hover { background: var(--dtr-hover-bg); transform: translateY(-1px); }
</style>
@endpush

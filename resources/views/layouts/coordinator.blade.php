...
<div class="layout-wrap">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('coordinator.attendance.logs') }}" class="{{ request()->routeIs('coordinator.attendance.logs') ? 'active' : '' }}"><i class="bi bi-clock-history"></i><span class="nav-text">Attendance Logs</span>@if($coordinatorPendingInvalidationCount > 0)<span class="nav-badge">{{ $coordinatorPendingInvalidationCount > 99 ? '99+' : $coordinatorPendingInvalidationCount }}</span>@endif</a>

  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .login-card {
      ...
      box-shadow: 0 10px 24px -18px rgba(37,99,235,0.25), 0 0 0 1px rgba(255,255,255,0.55), inset 0 1px 0 rgba(255,255,255,0.9);
      padding: clamp(1rem, 2.5vw, 1.35rem) clamp(0.9rem, 2.5vw, 1.2rem);
      transition: box-shadow 0.35s ease;
      border: 1px solid rgba(255,255,255,0.6);
    }
    .login-card:hover {
      box-shadow: 0 16px 34px -18px rgba(37,99,235,0.3), 0 0 0 1px rgba(255,255,255,0.6);
    }
    .login-header {
      text-align: center;
      margin-bottom: 1rem;
    ...
    .password-toggle-btn:hover { color: var(--dtr-primary); background: rgba(37,99,235,0.08); }
    html[data-theme="dark"] body {
      color: var(--dtr-text);
    }
    html[data-theme="dark"] body::before {
      background: radial-gradient(ellipse 100% 70% at 70% 20%, rgba(37,99,235,0.18) 0%, transparent 50%),
